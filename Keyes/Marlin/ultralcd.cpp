...
static void lcd_about_printer();
static void lcd_author_info();
static void lcd_author_contact();
...
static void lcd_about_printer()
{
    ...
    MENU_ITEM(gcode, "Keyes Rostock", PSTR(""));
    MENU_ITEM(gcode, "Delta Printer", PSTR(""));
    MENU_ITEM(gcode, "160mm X Y Axis", PSTR(""));
    MENU_ITEM(gcode, "258mm Z Axis", PSTR(""));
    MENU_ITEM(gcode, "1 Extruder", PSTR(""));
    MENU_ITEM(gcode, "Heated Bed", PSTR(""));
    MENU_ITEM(gcode, "1.75mm Filament", PSTR(""));
    MENU_ITEM(gcode, "Ramps 1.4", PSTR(""));
    MENU_ITEM(submenu, "Author Info:", lcd_author_info);
    END_MENU();
}
...
{
    START_MENU();
    MENU_ITEM(back, "Back", lcd_about_printer);
    MENU_ITEM(submenu, "Contact info:", lcd_author_contact);
    MENU_ITEM(gcode, "Seller: Jaycar", PSTR(""));
    MENU_ITEM(gcode, "Firmware By:", PSTR(""));
    MENU_ITEM(gcode, "James Campbell", PSTR(""));
    MENU_ITEM(gcode, "Jaycar 004721", PSTR(""));
...
{
  START_MENU();
  MENU_ITEM(back, "Back", lcd_author_info);
  MENU_ITEM(gcode, "Mobile:", PSTR(""));
  MENU_ITEM(gcode, "0435493711", PSTR(""));
  MENU_ITEM(gcode, "Email:", PSTR(""));
  MENU_ITEM(gcode, "sydneymakers@", PSTR(""));
  MENU_ITEM(gcode, "gmail.com", PSTR(""));
  MENU_ITEM(gcode, "", PSTR(""));
  END_MENU();
}
